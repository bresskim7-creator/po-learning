...
// v5.72.1 (2026-06-03): 발음 들어보기(설정 독립 진입) form-submit 리로드 버그 수정. 원인: page-settings가 <form>인데 audit 동적 버튼에 type 누락→기본 submit→앱 첫화면 리로드. 같은 렌더 경로 버튼 5종(앵커 단어목록·예전▶·오늘▶·전체기록·정확/애매/틀림 평가)에 type="button" 추가. 부모결과 화면(#parent-result <div>)은 영향 없어 회귀 0. 순수 버그픽스(기능 변경 0).
...
const CACHE_NAME = 'po-learning-v5721';
const PRECACHE = [
  './',
  './index.html',
  './growth.js',
