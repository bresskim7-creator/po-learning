...
// v5.97.0 (2026-08-04): 배치3 7/26~8/8 배포 — '오늘의 한 장' 14장 + '문해력 한 장' 14장(daily 7월 6 + 8월 8, 문해력 7월 6 + 8월 8). 신규 월파일 daily_2026-08.js·munhaerak_2026-08.js 2경로 PRECACHE 추가(이번 릴리스의 핵심 — daily_index.js는 이미 PRECACHE라 이 2경로 없이 배포하면 오프라인 기기가 8월 목록만 받고 본문을 못 받는다). daily_index 49→63항·munhaerak_index 22→36항, rotation history 28건(7/12~8/8) 재계산, calendar 7/29 세계 호랑이의 날(기념일)·8/7 입추(절기) 추가. 기존 July daily 25장·문해력 22장·index 49/22항 deep-equal 불변(HEAD 대조 확인). 8/8 동조(애시) 카드 출처는 1차 문헌 DOI(10.1037/h0093718). 데이터 정본 채택 GO(2026-08-04). 코드·렌더러·GAS·config 불변 — 데이터 8파일 + PRECACHE 2경로 + 버전 무효화. CACHE bump(v5960→v5970). 변경: daily_2026-07.js·daily_2026-08.js(신규)·daily_index.js·daily_one_page/·munhaerak_2026-07.js·munhaerak_2026-08.js(신규)·munhaerak_index.js·index.html·sw.js.
...
const CACHE_NAME = 'po-learning-v5970';
const PRECACHE = [
  './',
  './index.html',
  './growth.js',
