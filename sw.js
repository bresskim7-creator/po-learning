...
// v5.78.0 (2026-06-04): 독해 48·49·50·51·53·54회 48장 머지(comprehension.json append, displayIndex 172~219). 자동 스케줄러 초안(전부 reviewStatus parent_review·validationStatus pass) 머지. 카드 내용 무수정(displayIndex만 부여). 52회 없음(정상 갭). 코드/GAS 변경 0 — 데이터 머지 + 캐시 무효화 위한 CACHE_NAME bump.
...
const CACHE_NAME = 'po-learning-v5780';
const PRECACHE = [
  './',
  './index.html',
  './growth.js',
